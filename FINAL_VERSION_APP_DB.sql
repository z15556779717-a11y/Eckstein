...
DROP TABLE IF EXISTS workout_type_exercises CASCADE;
...
DROP TABLE IF EXISTS eckstein_meal_entries CASCADE;
DROP TABLE IF EXISTS eckstein_meals CASCADE;
DROP TABLE IF EXISTS eckstein_foods CASCADE;
DROP TABLE IF EXISTS calorie_bank CASCADE;
DROP TABLE IF EXISTS weight_entries CASCADE;
DROP TABLE IF EXISTS fat_meal_tracker CASCADE;
DROP TABLE IF EXISTS carb_load_tracker CASCADE;
DROP TABLE IF EXISTS milk_consumptions CASCADE;
...
-- ==========================================
-- DEVELOPMENT/TEST USER SUPPORT
-- ==========================================

-- Allow anonymous access for test user (development only)
-- Remove these policies in production!
CREATE POLICY "Anon can access test user" ON users FOR ALL TO anon 
    USING (id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user preferences" ON user_preferences FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user workouts" ON workouts FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user meals" ON meals FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user eckstein meals" ON eckstein_meals FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user weights" ON weight_entries FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user calorie bank" ON calorie_bank FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user fat meal tracker" ON fat_meal_tracker FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user carb load tracker" ON carb_load_tracker FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user milk consumptions" ON milk_consumptions FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user chat" ON chat_messages FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);

CREATE POLICY "Anon can access test user workout types" ON workout_types FOR ALL TO anon
    USING (user_id = '00000000-0000-0000-0000-000000000001'::uuid)
    WITH CHECK (user_id = '00000000-0000-0000-0000-000000000001'::uuid);
...
VALUES ('00000000-0000-0000-0000-000000000001', 'test@example.com', NOW(), NOW(), 'synced')
ON CONFLICT (id) DO NOTHING;

-- Insert default user preferences for test user
INSERT INTO user_preferences (user_id, daily_calorie_goal, daily_protein_goal, daily_carb_goal, weight_unit, activity_level)
VALUES ('00000000-0000-0000-0000-000000000001', 2000, 150, 250, 'kg', 'moderate')
